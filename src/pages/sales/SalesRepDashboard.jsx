  ...
  return (
    <Layout>
      <Box pb="10">
        ...
        >
          <Box zIndex="1">
            <Badge colorScheme="whiteAlpha" mb="2">Sales Representative Panel</Badge>
            <Heading size="lg" fontWeight="900" letterSpacing="-1px">
               Welcome Back, {data.name || 'Sales Partner'}
            </Heading>
            <Text fontSize="sm" opacity="0.9">Track your inventory and daily sales targets</Text>
          </Box>
          <HStack spacing="3" zIndex="1" mt={{ base: 4, md: 0 }}>
             <Menu>
                ...
                <MenuList zIndex="10" color="secondary" borderRadius="xl" shadow="2xl" border="none" p="2">
                   <MenuItem 
                      ...
                      fontSize="sm" 
                      borderRadius="lg"
                      onClick={() => navigate('/sales/new-invoice-gst')}
                   >
                      With GST Billing
                   </MenuItem>
                   <MenuItem 
             ...
             <Button leftIcon={<History size={18} />} variant="outline" color="white" borderRadius="xl" onClick={() => navigate('/sales/history')}>History</Button>
          </HStack>
        </Flex>
        ...
        <SimpleGrid columns={{ base: 1, sm: 2, xl: 4 }} spacing="6" mb="10">
          ...
          <StatCard 
            ...
            icon={Package}
            color="brand"
            subtitle="Units available for sale"
          />
          <StatCard 
          ...
          <StatCard 
            ...
            icon={Receipt}
            color="purple"
            subtitle="Your total conversions"
          />
        </SimpleGrid>
        ...
        <Grid templateColumns={{ base: "1fr", lg: "repeat(3, 1fr)" }} gap="8">
           <GridItem colSpan={{ base: 3, lg: 2 }}>
              <Box className="premium-card" p="8">
                 <Heading size="xs" mb="6" color="secondary" fontWeight="900">SALES PERFORMANCE</Heading>
                 <Box h="300px">
           ...
           <GridItem colSpan={{ base: 3, lg: 1 }}>
              <VStack spacing="8" align="stretch">
                 ...
                 <Box className="premium-card" p="6">
                    <Heading size="xs" mb="6" color="secondary" fontWeight="900">INVENTORY ALERTS</Heading>
                    {data.lowStockPreview.length === 0 ? (
                      <Flex direction="column" align="center" py="4">
                         ...
                         <Text fontSize="xs" mt="3" color="gray.500">Stock is healthy</Text>
                      </Flex>
                    ) : (
