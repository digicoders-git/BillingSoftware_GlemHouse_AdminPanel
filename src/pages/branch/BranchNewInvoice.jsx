    ...
    setItems(items.map(item => {
      if (item.id === id) {
        if (parsedQty > item.maxStock) {
          toast({ title: `Only ${item.maxStock} units available`, status: "warning", duration: 1500 });
        }
            ...
            <Box className="premium-card" p="0" overflow="hidden">
              ...
              <Box overflowX="auto">
                <Table variant="simple">
                  <Thead bg="gray.50/50">
                    <Tr>
                      <Th py="4" border="none" fontSize="10px">Description</Th>
                      <Th py="4" border="none" fontSize="10px" w="100px">Qty</Th>
                      <Th py="4" border="none" fontSize="10px" w="140px">Unit Price</Th>
                      <Th py="4" border="none" fontSize="10px" textAlign="right">Total</Th>
                      <Th py="4" border="none" fontSize="10px"></Th>
                    </Tr>
                  </Thead>
                  <Tbody>
                    {items.map((item) => (
